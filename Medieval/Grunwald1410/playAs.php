...
<style>
    ...
    body{
        background:url("<?=asset("vendor/wargame/medieval/grunwald1410/images/Jan_Matejko,_Bitwa_pod_Grunwaldem.jpg")?>") #333 no-repeat;
...
<h1 style="text-align:center;font-size:90px;font-family:'Lobster'">Grunwald 1410</h1>
<div class="clear">&nbsp;</div>
<fieldset ><Legend>Play As </Legend>
    ...
    <div class="attribution">
        Jan Matejko [Public domain], <a target='blank' href="https://commons.wikimedia.org/wiki/File%3AJan_Matejko%2C_Bitwa_pod_Grunwaldem.jpg">via Wikimedia Commons</a>
    </div>
</fieldset>
