...
use Wargame\AltFacingMoveRules;
use Wargame\Terrain;
...
class AncientsLandBattle extends \Wargame\LandBattle
{
    ...
    function __construct($data = null, $arg = false, $scenario = false, $game = false){
        ...
        if ($data) {
            ...
            $this->moveRules = new AltFacingMoveRules($this->force, $this->terrain);
            ...
            $this->gameRules->addPhaseChange(BLUE_FIRE_COMBAT_PHASE, BLUE_COMBAT_RES_PHASE, COMBAT_RESOLUTION_MODE, BLUE_FORCE, RED_FORCE, false);
            ...
            $this->gameRules->addPhaseChange(BLUE_COMBAT_PHASE, RED_FIRE_COMBAT_PHASE, FIRE_COMBAT_SETUP_MODE, RED_FORCE, BLUE_FORCE, false);


            $this->gameRules->addPhaseChange(RED_FIRE_COMBAT_PHASE, RED_COMBAT_RES_PHASE, COMBAT_RESOLUTION_MODE, RED_FORCE,BLUE_FORCE , false);
            ...
            $this->gameRules->addPhaseChange(RED_COMBAT_PHASE, BLUE_FIRE_COMBAT_PHASE, FIRE_COMBAT_SETUP_MODE, BLUE_FORCE, RED_FORCE, true);
        }
    ...
    protected function deployFirstMoveSecond(){
        ...
        $this->gameRules->addPhaseChange(BLUE_DEPLOY_PHASE, BLUE_FIRE_COMBAT_PHASE, FIRE_COMBAT_SETUP_MODE, BLUE_FORCE, RED_FORCE, false);
    }
    ...
    protected function deployFirstMoveFirst(){
        ...
        $this->gameRules->addPhaseChange(RED_DEPLOY_PHASE, BLUE_FIRE_COMBAT_PHASE, FIRE_COMBAT_SETUP_MODE, BLUE_FORCE, RED_FORCE, false);
    }
