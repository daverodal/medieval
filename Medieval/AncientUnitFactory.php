...
class AncientUnitFactory {
    ...
    public static function create($unitName,
        ...
        $unit->set($unitName, $unitForceId, $unitHexagon, $attackStrength, $defStrength, $flankStrength,$range,
            $unitMaxMove, $unitStatus, $unitReinforceZoneName, $unitReinforceTurn,  $nationality, $class, $unitDesig, $facing, $armorClass, $bow, $fireStrength);
